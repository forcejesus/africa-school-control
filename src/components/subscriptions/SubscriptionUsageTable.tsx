...
import { School, Users, GraduationCap, Gamepad2 } from "lucide-react";
            ...
            >
                ...
                {ecole.utilisation.enseignants ? (
                  <div className="space-y-1">
                    <div className="flex justify-between text-sm">
                      <span>{ecole.utilisation.enseignants.utilise}/{ecole.utilisation.enseignants.limite}</span>
              ...
              <TableCell className="text-base">
                {ecole.utilisation.apprenants ? (
                  <div className="space-y-1">
                    <div className="flex justify-between text-sm">
                      <span>{ecole.utilisation.apprenants.utilise}/{ecole.utilisation.apprenants.limite}</span>
              ...
              <TableCell className="text-base">
                {ecole.utilisation.jeux ? (
                  <div className="space-y-1">
                    <div className="flex justify-between text-sm">
                      <span>{ecole.utilisation.jeux.utilise}/{ecole.utilisation.jeux.limite}</span>
